  ...
  return (
    <div className='bg-gray-300 dark:bg-gray-700 w-fit py-1 px-2 m-1 rounded-md relative' onMouseEnter={() => setShowMessageActions(true)} onMouseLeave={() => setShowMessageActions(false)}>
      {showMessageActions && <Form className="bg-gray-300 dark:bg-gray-700 border-2 rounded-md p-1 absolute dark:border-gray-900 -bottom-5 flex gap-1 z-10">
        ...
        <button type="submit" _action="reaction" className=' -right-0.5 top-0.5' value="smile"><FaSmile className="text-yellow-300 text-lg" /></button>
        <button type="submit" _action="reaction" className=' -right-0.5 top-0.5' value="frown"><FaFrown className="text-yellow-300 text-lg" /></button>
        <button type="submit" _action="reaction" className=' -right-0.5 top-0.5' value="laugh"><FaLaugh className="text-yellow-300 text-lg" /></button>
        <button type="submit" _action="reaction" className=' -right-0.5 top-0.5' value="poop"><FaPoop className="text-yellow-900 text-lg" /></button>
      </Form>}
